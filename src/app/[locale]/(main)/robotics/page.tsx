  ...
  return (
    <div>
        <Breadcrumbs>
            ...
            <BreadcrumbItem href="/robotics">{tc("Robotics")}</BreadcrumbItem>
        </Breadcrumbs>
        <ProductList loop={true} className="mx-auto max-w-screen-lg mt-8" products={products} title={tc("robotics.title")} subtitle={tc("robotics.subtitle")} showAll />
    </div>
  )
}
