...
const Footer = () => {
    ...
    return (
        <footer className='bg-red-500 w-full mt-12 text-white'>
            <div className="grid grid-cols-4 grid-rows-4 gap-4 mx-auto max-w-screen-lg px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
                ...
                <div className='col-span-4 row-start-3 flex items-center flex-col sm:flex-row justify-start sm:justify-between border-t pt-4 border-white'>
                    <div className="">
                ...
                <div className='col-span-4 row-start-4 border-t border-white -mt-12 sm:-mt-0  sm:pt-4 pt-0 flex items-center justify-between '>
